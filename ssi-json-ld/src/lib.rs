...
pub const OB_V303_CONTEXT: Iri = iri!("https://purl.imsglobal.org/spec/ob/v3p0/context-3.0.3.json");
...
pub const LEARNCARD_BOOSTS_V1_0_1_CONTEXT: Iri =
...
lazy_static::lazy_static! {
    ...
    pub static ref LEARNCARD_BOOSTS_V1_0_2_CONTEXT_DOCUMENT: RemoteDocument = load_static_context(
    ...
    pub static ref LEARNCARD_DELEGATES_CONTEXT_DOCUMENT: RemoteDocument = load_static_context(
        LEARNCARD_DELEGATES_CONTEXT,
        ssi_contexts::LEARNCARD_DELEGATES_V1_0_0,
    );
    pub static ref LEARNCARD_QA_CONTEXT_DOCUMENT: RemoteDocument = load_static_context(
        LEARNCARD_QA_CONTEXT,
        ssi_contexts::LEARNCARD_QA_V1_0_0,
    );
    ...
    pub static ref PLUGFEST_V2_CONTEXT_DOCUMENT: RemoteDocument = load_static_context(
        PLUGFEST_V2_CONTEXT,
        ssi_contexts::PLUGFEST_V2,
    );
    ...
    pub static ref OB_V303_CONTEXT_DOCUMENT: RemoteDocument = load_static_context(
        OB_V303_CONTEXT,
        ssi_contexts::OBV303,
    );
